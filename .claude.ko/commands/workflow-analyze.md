...
- [왜 좋은가 - 사용자/기술 관점]
- [실제 장점을 모두 나열 - 인위적으로 제한하거나 부풀리지 말 것]

**단점**:

- [왜 문제가 될 수 있는가]
- [실제 단점을 모두 나열 - 숨기지 말 것]

**부작용/위험** (있다면):

- [성공적으로 구현해도 발생할 수 있는 부정적 결과]
- [숨겨진 비용, 유지보수 부담, 도입되는 기술 부채]
- [없다면: "확인된 부작용 없음" 또는 섹션 생략]
...
- [유의미한 것이 없다면: "최소 - 선택한 방안이 이 경우 확실히 우수함"]

**알려진 위험** (있다면):

- [성공적으로 구현해도 발생할 수 있는 문제]
- [확인된 것이 없다면 솔직하게 기술]
...
- [ ] 사실대로 작성했는가 (숨기지도, 만들지도 않음)
- [ ] 반려 방안의 포기하는 이점을 인정했는가
- [ ] 중립적 언어 사용했는가 ("~할 수 있다", "명백히" 금지)
```
...
**❌ 나쁜 예**: "단점 없이 최고의 솔루션. 방안 2 반려: 너무 복잡함."

**✅ 좋은 예**: "방안 1 선택. 트레이드오프: 방안 2의 30% 더 좋은 처리량 포기. 위험: 엣지 케이스 X에서 메모리 증가 가능."
