...
1. **`.claude.ko/commands/workflow-analyze.md` 읽고** 전체 과정 실행
2. 멈추지 않고 **`.claude.ko/commands/workflow-plan.md` 읽고** 실행 (단일 커밋만)
3. 멈추지 않고 **`.claude.ko/commands/workflow-execute.md` 읽고** 커밋 1 실행
4. 멈추지 않고 **`.claude.ko/commands/commit.md` 읽고** commit_message.md 생성
